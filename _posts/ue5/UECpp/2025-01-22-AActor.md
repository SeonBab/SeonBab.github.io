...
![AActor-NewAActor]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-NewAActor.PNG)

팝업 창이 뜨는데, 일반 클래스 탭에서 `Actor`를 선택한 뒤 다음 버튼을 누릅니다.

![AActor-CommonClasses]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-CommonClasses.PNG)

혹은 모든 클래스 탭에서 `Actor`를 검색하는 등 찾은 뒤 다음 버튼을 누릅니다.

![AActor-AllClasses]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-AllClasses.PNG)
...
![AActor-NameNewActor]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-NameNewActor.PNG)

잠시 후 자동 빌드가 진행되며, 완료 되면 비주얼 스튜디오에서 프로젝트가 변경되었다는 메시지가 뜰 수 있습니다.  
여기서 Reload All을 선택합니다.

![AActor-FileModificationDetected]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-FileModificationDetected.PNG)

비주얼 스튜디오의 솔루션 탐색기를 살펴보면 다음과 같이 파일이 생성된 것을 확인 할 수 있습니다.  
저의 경우 클래스 타입을 `Public`으로 설정했기 때문에 다음과 같은 구조가 됐습니다.

![AActor-SolutionExplorer]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-SolutionExplorer.PNG)

언리얼 에디터의 콘텐츠 브라우저에도 변화가 있는데, C++ 클래스 > 프로젝트명 폴더 아래에도 C++로 생성한 클래스가 나타나게 됩니다.

![AActor-ContentBrowser]({{site.url}}/images/Unreal/uecpp/2025-01-22-AActor/AActor-ContentBrowser.PNG)
